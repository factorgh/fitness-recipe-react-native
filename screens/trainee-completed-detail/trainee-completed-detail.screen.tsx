...
export default function TraineeCompletedDetailScreen() {
  ...
  return (
    ...
    <View className='flex-row items-center mt-5 mx-5 font-semibold'>
        <Text  style={{fontFamily:"Nunito_400Regular"}} className='textslate-800 text-md'>Status :</Text>
        <Text style={{fontFamily:"Nunito_400Regular"}} className='text-orange-500 pl-2'>Completed</Text>
      </View>
      </LinearGradient>
    </SafeAreaView> 
  )
